  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-linear-to-br from-[#050F1F] to-[#0A1D3A] text-white pt-26 pb-16 px-4">
        <div className="absolute inset-0 opacity-5 bg-[url('/images/pexels-rudonni-7114280.jpg')] bg-cover bg-center"></div>
        <div className="max-w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 py-4">
                <p className="inline-flex items-center gap-2 px-4 py-0.5 rounded-lg
                    bg-[rgba(230,184,76,0.1)]
                    border border-[rgba(230,184,76,0.6)]
                    text-[#F2C94C] text-xs">Live · LBMA-aligned</p>
                <h1 className="text-6xl font-bold leading-tight">
                The Gold Market<br />
                <span className="bg-gradient-to-br from-[#F6C65B] to-[#D99A1F] bg-clip-text text-transparent">Index & API</span><span> Provider</span>

                </h1>
                <p className="text-slate-300 text-lg max-w-md">
                Reference-grade gold pricing, shop rankings, and predictive sentiment delivered through a developer-first API. [cite: 11]
                </p>
                <div className="flex space-x-4">
                <button className="bg-yellow-400 hover:bg-yellow-500 text-black px-6 py-3 rounded-md font-semibold">Start free →</button>
                <button className="bg-slate-800 hover:bg-slate-700 text-white px-6 py-3 rounded-md font-semibold">View API docs</button>
                
                </div>
                <div className="max-w-full mx-auto border-t border-gray-700 py-10">
                <div className="flex space-between">
                    <div className="flex-1">
                        <p className="text-2xl text-[#D99A1F] font-bold"> 1s</p>
                        <p className="text-sm text-gray-500">Update freq</p>
                    </div>
                    <div className="flex-1">
                        <p className="text-2xl text-[#D99A1F] font-bold">120+</p>
                        <p className="text-sm text-gray-500">Shops indexed</p>
                    </div>
                    <div className="flex-1 ">
                        <p className="text-2xl text-[#D99A1F] font-bold">99.99%</p>
                        <p className="text-sm text-gray-500">API uptime</p>
                    </div>
                </div>
            </div>
            </div>
            <div className="bg-[#f8fafc] rounded-2xl p-6 md:p-8 shadow-2xl w-full max-w-2xl mx-auto font-sans relative z-10 border border-slate-100">
            {/* Header ของกราฟ */}
            <div className="flex justify-between items-start mb-6">
                ...
                <h3 className="text-4xl font-bold text-[#0B152A]">
                    ฿2,398.40
                </h3>
                </div>
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            From a free embeddable widget to institutional real-time feeds — pick what fits.
            </p>
        </div>
        ...
        <section className="py-24 px-4 bg-white font-sans text-slate-900">
            <div className="max-w-full mx-auto space-y-32">
                ...
                <div>
                    ...
                    One copy-paste line. Watermarked widget with a 15-minute delay — perfect for blogs, marketing sites and shop pages.
                    </p>
                </div>
                ...
                <div className="shadow-2xl rounded-xl">
                    ...
                    <pre>
                        ...
                        <span className="text-slate-300">src="https://cdn.aurumindex.io/widget.js"</span>
                        <br />
                        <span className="text-slate-300 pl-8">data-key="public" data-symbol="XAUTHB"</span>
                        <br />
                ...
                <div className="order-2 lg:order-1 overflow-x-auto bg-white rounded-xl shadow-sm border border-slate-100 p-2">
                    ...
                    <tbody className="divide-y divide-slate-100">
                        ...
                        <td className="py-4 px-4"><span className="flex items-center justify-center w-6 h-6 border border-yellow-400 text-yellow-600 rounded-full text-xs font-bold">1</span></td>
                        <td className="py-4 px-4 font-medium text-[#0B152A]">Hua Seng Heng</td>
                        <td className="py-4 px-4 text-right">8</td>
                        <td className="py-4 px-4 text-right">250</td>
                        <td className="py-4 px-4 text-center pl-8"><ArrowTrendingDownIcon className="w-5 h-5 text-green-500 shrink-0" /></td>
                        </tr>
                        <tr className="hover:bg-slate-50 transition-colors">
                        <td className="py-4 px-4 text-slate-400 pl-6">2</td>
                        <td className="py-4 px-4 font-medium text-[#0B152A]">YLG Bullion</td>
                        ...
                        <td className="py-4 px-4 font-medium text-[#0B152A]">MTS Gold</td>
                        <td className="py-4 px-4 text-right">12</td>
                        <td className="py-4 px-4 text-right">300</td>
                        <td className="py-4 px-4 text-center pl-8"><ArrowTrendingUpIcon className="w-5 h-5 text-red-500 shrink-0" /></td>
                        </tr>
                        <tr className="hover:bg-slate-50 transition-colors">
                        <td className="py-4 px-4 text-slate-400 pl-6">4</td>
                        <td className="py-4 px-4 font-medium text-[#0B152A]">Ausiris</td>
                        ...
                        <td className="py-4 px-4 font-medium text-[#0B152A]">Classic Gold</td>
                ...
                <div className="order-1 lg:order-2">
                    ...
                    <p className="text-lg text-slate-500 leading-relaxed">
                    Programmatic access to 120+ Thai bullion shops — ranked by the lowest spread and making charges, refreshed every 5 minutes.
                    </p>
                </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center pt-8 border-t border-slate-50">
          ...
          <div>
            ...
            <p className="text-lg text-slate-500 leading-relaxed">
              Institutional feeds with WebSocket streaming, event webhooks, and a proprietary Market Sentiment Score blending news, futures and order-flow.
            </p>
          </div>
